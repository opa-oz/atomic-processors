...
namespace AtomicProcessors::Templater {
    ...
    void init(CLI::App &app) {
        ...
        templater->callback([&]() { process(_input_path, _variables, _output_path); });
        ...
        templater_files->add_option("--input2", _variables_file, "JSON file with variables object")->required()->check(
                CLI::ExistingFile);
